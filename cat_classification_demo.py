...
#
# MODIFIED BY CATHRYN PLOEHN 2021

"""Classification detection demo."""
import argparse
import collections
import contextlib
import io
...
def run_inference(num_frames, on_loaded):
    ...
    with CameraInference(image_classification.model()) as inference:
        ...
        for result in inference.run(num_frames):
            yield image_classification.get_classes(result, top_k=1), (result.width, result.height)
